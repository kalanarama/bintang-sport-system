    ...
    <form action="{{ route('admin.lapangan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="durasi_slot" class="form-select @error('durasi_slot') is-invalid @enderror">
                ...
                <option value="30" {{ old('durasi_slot') == '30' ? 'selected' : '' }}>30 Menit</option>
                <option value="60" {{ old('durasi_slot') == '60' ? 'selected' : '' }}>60 Menit</option>
                <option value="90" {{ old('durasi_slot') == '90' ? 'selected' : '' }}>90 Menit</option>
                <option value="120" {{ old('durasi_slot') == '120' ? 'selected' : '' }}>120 Menit</option>
            </select>
            @error('durasi_slot')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
